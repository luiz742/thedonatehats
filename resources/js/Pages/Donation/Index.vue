            ...
            <div class=" max-w-3xl w-full text-center">
                ...
                <transition name="fade">
                    <div v-if="showModal"
                        ...
                        <!-- Modal Content -->
                        <div
                            class="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl relative transition-all max-h-[90vh] overflow-y-auto">
                            <!-- Close Button -->
                            <button class="absolute top-3 right-3 text-gray-400 hover:text-black text-2xl"
                                @click="closeModal">
                                &times;
                            </button>
                            ...
                            <div v-if="!donationPending">
                                <h2 class="text-xl font-semibold mb-5 text-gray-800 text-center">Choose a donation
                                    amount</h2>
                                <div class="grid grid-cols-2 gap-4 mb-6">
                                    <button v-for="amount in amounts" :key="amount" @click="selectedAmount = amount"
